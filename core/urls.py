...
from .views import RegisterAPIView, WorkspaceAPIView, ProjectListCreateAPIView, FeatureListCreateAPIView, RetrieveUserProfileAPIView, WorkspaceDetailAPIView, ProjectDetailAPIView, FeatureDetailAPIView, VerifyEmailAPiView
